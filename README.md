...
- A content-addressed real-candidate preflight that parses fixture prices and anonymous book depth lexically into `bigint`, binds a common five-share route, and blocks the exact verifier when gross floor, generation, fee, route, or review prerequisites are absent.
